...
async function transferPKTTokens() {
  console.log("🚀 PKT Token Transfer Script");
  console.log("============================");
  ...
  try {
    ...
    try {
      ...
      console.log("This might not be a valid ERC20 token contract");
      return;
    }
    console.log("");
    ...
    if (error.code === 'INSUFFICIENT_FUNDS') {
      ...
      console.log("\n💡 Suggestion: The contract address might not be a valid ERC20 token");
    }
  }
}
