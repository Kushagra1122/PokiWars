...
const PokemonCard = ({
  ...
  return (
    <div className="relative w-48 h-64 overflow-hidden rounded-lg border-2 border-white/30 cursor-pointer hover:border-white/50 transition-all duration-200 hover:scale-105"
      onClick={onClick}
    >
      <div
        className="absolute inset-0 bg-cover bg-center bg-gray-700 mb-20"
        style={{
