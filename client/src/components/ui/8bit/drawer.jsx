...
function DrawerTrigger({
  ...
  return (
    <ShadcnDrawerTrigger
      ...
      !asChild &&
        "border-foreground dark:border-ring hover:bg-transparent active:bg-transparent focus:bg-transparent rounded-none border-4 focus:border-foreground hover:border-foreground dark:focus:border-ring bg-transparent data-[state=open]:bg-transparent data-[state=open]:border-foreground dark:data-[state=open]:border-ring", className, "retro")}
      asChild={asChild}
      {...props}>
      {children}
    </ShadcnDrawerTrigger>
